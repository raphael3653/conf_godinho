...
<layer id="{8b82ae89-3892-4244-a408-b3b6fa5d8fe2}" pass="0" class="SimpleLine" locked="0" enabled="1">
<Option type="Map">
...
<layer id="{a9e5ef3c-f313-4a15-a2cc-f53255286f02}" pass="0" class="SimpleFill" locked="0" enabled="1">
<Option type="Map">
...
<layer id="{28c5a87b-ebca-409b-9249-c3a07e38d084}" pass="0" class="SimpleMarker" locked="0" enabled="1">
<Option type="Map">
...
<layer id="{317cf2fa-dd20-4a12-ad9b-c980b7f06c60}" pass="0" class="SimpleFill" locked="0" enabled="1">
<Option type="Map">
<Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
...
<field name="nome_sensor" configurationFlags="None">
<editWidget type="">
<config>
<Option/>
</config>
...
<field name="nome_abrev_sensor" configurationFlags="None">
<editWidget type="">
<config>
<Option/>
</config>
...
<alias name="" index="1" field="nome_sensor"/>
<alias name="" index="2" field="nome_abrev_sensor"/>
<alias name="" index="3" field="data"/>
...
<policy policy="Duplicate" field="nome_sensor"/>
<policy policy="Duplicate" field="nome_abrev_sensor"/>
...
<default expression="" field="nome_sensor" applyOnUpdate="0"/>
<default expression="" field="nome_abrev_sensor" applyOnUpdate="0"/>
...
<constraint notnull_strength="0" exp_strength="0" field="nome_sensor" constraints="0" unique_strength="0"/>
<constraint notnull_strength="0" exp_strength="0" field="nome_abrev_sensor" constraints="0" unique_strength="0"/>
<constraint notnull_strength="0" exp_strength="0" field="data" constraints="0" unique_strength="0"/>
...
<constraint field="nome_sensor" exp="" desc=""/>
<constraint field="nome_abrev_sensor" exp="" desc=""/>
