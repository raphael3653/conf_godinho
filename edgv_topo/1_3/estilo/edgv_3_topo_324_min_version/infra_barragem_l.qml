...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{c14cf079-ce50-49bb-a35f-5272dc75769b}">
      <rule key="{b27ab26a-4313-4a60-880c-be5ba14e2dc4}" filter="tipo in (1,2) AND &quot;material_construcao&quot; in (0,1,2,3,4,5,23)" symbol="0" label="Ok"/>
      <rule key="{9c35490e-45d8-423e-958f-358278266d75}" filter="sobreposto_transportes = 1" symbol="1" label="Canteiro"/>
      <rule key="{424f18d4-588f-48d1-bf23-469df0fb7ef2}" filter=" &quot;tipo&quot; = 9999 or &quot;material_construcao&quot; = 9999" symbol="2" label="Erro"/>
      <rule key="{63e25090-4cfd-4fb1-91c7-95a8e2107c04}" symbol="3" label="Vértices"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" alpha="1" name="2">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="0" type="QString" name="draw_inside_polygon"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="255,0,23,255" type="QString" name="line_color"/>
            <Option value="solid" type="QString" name="line_style"/>
            <Option value="1.5" type="QString" name="line_width"/>
            <Option value="MM" type="QString" name="line_width_unit"/>
            <Option value="0" type="QString" name="offset"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,0,23,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.5"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" alpha="1" name="3">
        ...
        <layer enabled="1" class="MarkerLine" pass="0" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" alpha="1" name="@3@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
              ...
              <prop k="offset" v="0,-0.30476200000000003"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
  ...
  <labeling type="rule-based">
    <rules key="{b180d91a-adbd-4f00-bac5-f468f5284b72}">
      <rule key="{05f1440c-f7e1-4558-9d9f-298297739718}" filter="is_selected()">
      ...
      <rule key="{c03e0f7f-ae4f-416a-9396-faaec401760d}" filter="is_selected()">
        <settings calloutType="simple">
          ...
          <text-format addDirectionSymbol="0" decimals="3" multilineAlign="0" rightDirectionSymbol=">" formatNumbers="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" wrapChar="" autoWrapLength="0" reverseDirectionSymbol="0" plussign="0" leftDirectionSymbol="&lt;"/>
          <placement repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" offsetUnits="MM" lineAnchorClipping="0" placement="3" priority="5" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="1" maxCurvedCharAngleIn="25" distUnits="MM" rotationAngle="0" fitInPolygonOnly="0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" geometryGenerator="" centroidInside="0" repeatDistanceUnits="MM" layerType="LineGeometry" yOffset="0" preserveRotation="1" lineAnchorType="0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" offsetType="0" placementFlags="14" lineAnchorPercent="0.5" centroidWhole="0" geometryGeneratorEnabled="0" rotationUnit="AngleDegrees"/>
          <rendering upsidedownLabels="0" zIndex="0" minFeatureSize="0" unplacedVisibility="0" obstacle="1" obstacleType="1" limitNumLabels="0" scaleVisibility="0" displayAll="0" scaleMin="0" fontLimitPixelSize="0" drawLabels="1" fontMaxPixelSize="10000" obstacleFactor="1" scaleMax="0" maxNumLabels="2000" labelPerPart="0" mergeLines="0" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
